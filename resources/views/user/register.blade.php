...
<body class="h-full">
    <div class="h-screen w-screen flex flex-col lg:flex-row overflow-hidden">
        ...
        <div class="w-full lg:w-1/2 min-h-screen overflow-y-auto bg-white px-4 text-small">
            <div class="w-full max-w-md mx-auto py-12">
                ...
                <div class="space-y-4 max-w-2xl mx-auto">
                    ...
                    @if (session('success'))
                        <div class="bg-green-50 border-l-4 border-green-500 rounded-lg shadow-sm">
                ...
                <div class="mt-6 space-y-4">
                    ...
                    <form action="{{ route('user.google') }}" method="GET">
                        <button type="submit"
                            class="w-full flex items-center justify-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                            <img src="https://www.svgrepo.com/show/475656/google-color.svg" alt="Google logo"
                                class="h-5 w-5 mr-2" />
                ...
                <p class="mt-6 text-center text-sm text-gray-600">
                    ...
                    <a href="{{ route('user.login') }}" class="font-medium text-orange-600 hover:text-orange-500">
                        Login
                    </a>
                </p>
            </div>
