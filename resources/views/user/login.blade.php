...
<body class="h-full">
    <div class="h-screen w-screen flex flex-col lg:flex-row overflow-hidden">
        ...
        <div class="w-full lg:w-1/2 bg-white px-4 h-100 overflow-y-auto text-sm">
            <div class="w-full max-w-md mx-auto py-12">
                ...
                <p class="mt-6 text-center text-sm text-gray-600">
                    Are you new here?
                    <a href="{{ route('user.register') }}" class="font-medium text-orange-600 hover:text-orange-500">
                        Create Account
                    </a>
                </p>
            </div>
